...
public class SessionClusterServiceStepDecorator extends AbstractFlinkConfigurationStepDecorator {
    ...
    public Map<String, String> decorate(Map<String, String> parameters) {
        ...
        flinkConfiguration.putAll(FlinkServiceUtil.addLoadBalancerService());
