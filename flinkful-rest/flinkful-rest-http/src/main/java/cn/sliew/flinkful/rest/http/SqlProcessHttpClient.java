...
public class SqlProcessHttpClient extends AsyncClient implements
    ...
    @Override
    public CompletableFuture<GetSessionConfigResponseBody> getSessionConfig(String sessionHandle)
    ...
    @Override
    public CompletableFuture<EmptyResponseBody> heartbeat(String sessionHandle)
        throws IOException, ConversionException {
    ...
    @Override
    public CompletableFuture<CloseSessionResponseBody> closeSession(String sessionHandle)
        throws IOException, ConversionException {
        String url = webInterfaceURL + "/sessions/" + sessionHandle;
        Request request = new Request.Builder()
            .delete()
    ...
    @Override
    public CompletableFuture<ExecuteStatementResponseBody> executeStatement(String sessionHandle,
        ...
        RequestBody body = RequestBody
            .create(FlinkShadedJacksonUtil.toJsonString(requestBody), APPLICATION_JSON);
        Request request = new Request.Builder()
            .post(body)
            .url(url)
            .build();
    ...
    @Override
    public CompletableFuture<OperationStatusResponseBody> getOperationStatus(String sessionHandle,
    ...
    @Override
    public CompletableFuture<OperationStatusResponseBody> cancelOperation(String sessionHandle,
        String operationHandle) throws IOException, ConversionException {
        String url =
            webInterfaceURL + "/sessions/" + sessionHandle + "/operations/" + operationHandle
                + "/cancel";
    ...
    @Override
    public CompletableFuture<OperationStatusResponseBody> closeOperation(String sessionHandle,
        String operationHandle) throws IOException, ConversionException {
        String url =
            webInterfaceURL + "/sessions/" + sessionHandle + "/operations/" + operationHandle
                + "/close";
